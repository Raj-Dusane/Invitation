...
$(document).on('click', function(){
    ...
    console.log('Engagement La Nakki Ya!');
});

// Set the date we're counting down to
var countDownDate = new Date("Aug 27, 2024 10:30:00").getTime();
...
// console.log('\n\n%c SAVE THE DATE: 27th Aug, 2024!', styles);

// console.log('%cYour presence is requested!%c\n\nRegards: Raj Dusane', styles1, styles2);

// console.log(
//     `%cEngagement La Nakki Ya!\n\n`,
